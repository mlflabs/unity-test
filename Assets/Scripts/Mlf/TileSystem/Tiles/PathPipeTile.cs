...
namespace Mlf.TileSystem.Tiles
{
    ...
    /// </summary>
    [Serializable]
    [CreateAssetMenu(fileName = "New PathPipeline Tile", menuName = "Mlf/Tiles/PathPipeline Tile")]
    public class PathPipelineTile : TileBase, IPathBaseTile
    {
...
#if UNITY_EDITOR
    [CustomEditor(typeof(PathPipelineTile))]
    public class PathPipelineTileEditor : Editor
    {
        private PathPipelineTile tile { get { return (target as PathPipelineTile); } }

...
namespace Mlf.TileSystem.Tiles {
    ...
    [Serializable]
    [CreateAssetMenu(fileName = "New PathTerrain Tile", menuName = "Mlf/Tiles/PathTerrain Tile")]
    public class PathTerrainTile : TileBase, IPathBaseTile
    {
...
#if UNITY_EDITOR
    [CustomEditor(typeof(PathTerrainTile))]
    public class TerrainTileEditor : Editor
    {
        private PathTerrainTile tile { get { return (target as PathTerrainTile); } }
